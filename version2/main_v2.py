...
from stress_test import run_low_stress_test, run_high_stress_test, run_occupancy_analysis, run_comparative_test, clear_test_data
import sys
import os
...
class RestaurantApp:
    ...
    def display_menu(self):
        ...
        print("3. Найти мои бронирования")
        print("4. Нагрузочное тестирование (низкая нагрузка)")
        print("5. Нагрузочное тестирование (высокая нагрузка)")
        print("6. Анализ заполняемости")
        print("7. Сравнительный тест нагрузок")
